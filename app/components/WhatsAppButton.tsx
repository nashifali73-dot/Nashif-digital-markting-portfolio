  ...
  return (
    <motion.a
      ...
      whileHover={{ 
        scale: 1.15,
        rotate: 5,
        filter: "drop-shadow(0 10px 25px rgba(37, 211, 102, 0.4))"
      }}
      whileTap={{ scale: 0.9 }}
    >
      <div className="w-14 h-14 lg:w-16 lg:h-16 rounded-full bg-gradient-to-br from-[#25D366] to-[#128C7E] flex items-center justify-center shadow-2xl relative overflow-hidden">
        {/* Liquid shine effect */}
        <motion.div
        ...
        {/* WhatsApp Icon */}
        <svg 
          className="w-7 h-7 lg:w-8 lg:h-8 text-white relative z-10" 
          fill="currentColor" 
          viewBox="0 0 24 24"
        >
